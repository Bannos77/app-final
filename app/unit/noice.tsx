  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/noice-marine.jpg')}
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.titleRow}>
          <Text style={styles.name}>Noice Marines</Text>
          <Text style={styles.points}>170 pts</Text>
        </View>
        ...
        <Text style={styles.sectionTitle}>Blastmaster - single frequency </Text> 
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['48"', '3', '4+', '9', '-2', '3'])}
        </View>
        <Text style={styles.sectionExtra}>HEAVY</Text>

        <Text style={styles.sectionTitle}>Blastmaster - multi frequency</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['36"', '6', '3+', '6', '-1', '1'])}
        </View>
        ...
        <Text style={styles.sectionTitle}>Doom siren</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['12"', 'D6', 'N/A', '6', '-1', '1'])}
        </View>
        <Text style={styles.sectionExtra}>TORRENT</Text>
        ...
        <Text style={styles.sectionTitle}>Sonic Blaster</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['24"', '3', '3+', '5', '0', '1'])}
        </View>
        <Text style={styles.sectionExtra}>ASSAULT</Text>
        ...
        <Text style={styles.sectionTitle}>Accursed weapon</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'WS', 'S', 'AP', 'D'], true)}
