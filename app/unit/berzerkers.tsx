...
const FabiusBileCard = () => {
  ...
  const userId = '123';
  const itemId = 'khorne-berzerkers';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/unit-berzerker.jpg')}
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.sectionExtra}>HAZARDOUS, PISTOL</Text>

        <Text style={styles.sectionTitle}>Melee Weapons</Text>
        <Text style={styles.sectionName}>Berzerker chainblade</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['Melee', '4', '3+', '5', '-1', '1'])}
        </View>

        <Text style={styles.sectionName}>Khornate eviscerator</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
