  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/unit-terminator.jpg')}
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.titleRow}>
          <Text style={styles.name}>Terminator Squad</Text>
          <Text style={styles.points}>340 pts</Text>
        </View>

        <View style={styles.statTable}>
          {renderStatRow(['M', 'T', 'Sv', 'W', 'Ld', 'Oc'], true)}
          {renderStatRow(['5"', '5', '2+', '3', '6+', '1'])}
        </View>

        <Text style={styles.sectionTitle}>Assault cannon</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['24"', '6', '3+', '6', '0', '1'])}
        </View>
        <Text style={styles.sectionExtra}>DEVASTATING WOUNDS</Text>

        <Text style={styles.sectionTitle}>Cyclone missile launcher - krak</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['36"', '2', '3+', '9', '-2', 'd6'])}
        </View>
        <Text style={styles.sectionExtra}>DEVASTATING WOUNDS</Text>

        <Text style={styles.sectionTitle}>Cyclone missile launcher - frag</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['36"', '2D6', '3+', '4', '0', '1'])}
        </View>
        <Text style={styles.sectionExtra}>BLAST</Text>

        <Text style={styles.sectionTitle}>Heavy flamer</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
        ...
        <Text style={styles.sectionTitle}>Storm bolter</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
        ...
        <Text style={styles.sectionTitle}>Chainfist</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'WS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['Melee', '3', '3+', '8', '-2', '2'])}
        </View>
        <Text style={styles.sectionExtra}>ANTI-VEHICLE 3+</Text>
