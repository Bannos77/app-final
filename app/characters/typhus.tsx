  ...
  const router = useRouter();
    ...
    return (
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/typhus.jpg')} // Local image file
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.titleRow}>
          <Text style={styles.name}>Typhus</Text>
          <Text style={styles.points}>80 pts</Text>
        </View>

        <View style={styles.statTable}>
          {renderStatRow(['M', 'T', 'Sv', 'W', 'Ld', 'Oc'], true)}
          {renderStatRow(['5"', '6', '2+', '6', '6+', '1'])}
        </View>

        <Text style={styles.sectionTitle}>Melee Weapons</Text>
        <Text style={styles.sectionName}>Master-crafted manreaper - strike</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'WS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['Melee', '5', '2+', '9', '-2', '3'])}
        </View>
        <Text style={styles.sectionExtra}>LETHAL HITS</Text>

        <Text style={styles.sectionName}>Master-crafted manreaper - sweep</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'WS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['Melee', '10', '2+', '6', '-1', '1'])}
        </View>
        <Text style={styles.sectionExtra}>LETHAL HITS</Text>
