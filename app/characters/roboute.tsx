...
const RobouteGuillimanCard = () => {
  ...
  const userId = '123';
  const itemId = 'roboute-guilliman';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/roboute-guilliman.jpg')}
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.titleRow}>
          <Text style={styles.name}>Roboute Guilliman</Text>
...
export default RobouteGuillimanCard;
