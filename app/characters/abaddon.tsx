...
import { API_URL } from '@/constants/Api'; // can be base (/api) or full (/favorites)
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.buttonRow}>
        ...
        >
          <Text style={styles.favoriteText}>{isFavourite ? '★' : '☆'} Favourite</Text>
        </TouchableOpacity>
      </View>

      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/abaddon.jpg')}
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'WS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['Melee', '14', '2+', '7', '-3', '1'])}
        </View>
        <Text style={styles.sectionExtra}>DEVASTATING WOUNDS</Text>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  sectionName: { fontSize: 14, fontWeight: '500', color: '#fff', marginTop: 10, marginBottom: 0 }, // '500' instead of 'medium'
