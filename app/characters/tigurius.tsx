    ...
    return (
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.titleRow}>
          <Text style={styles.name}>Chief Librarian Tigurius</Text>
          <Text style={styles.points}>75 pts</Text>
        </View>

        <View style={styles.statTable}>
          {renderStatRow(['M', 'T', 'Sv', 'W', 'Ld', 'Oc'], true)}
          {renderStatRow(['6"', '4', '3+', '4', '6+', '1'])}
        </View>
        ...
        <Text style={styles.sectionName}>Rod of Tigurius</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['18"', 'D6', '2+', '6', '-2', '2'])}
        </View>
        <Text style={styles.sectionExtra}>BLAST, PSYCHIC</Text>

        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
          {renderWeaponRow(['18"', '2D6', '2+', '6', '-2', '2'])}
        </View>
        <Text style={styles.sectionExtra}>BLAST, HAZARDOUS, PSYCHIC</Text>
