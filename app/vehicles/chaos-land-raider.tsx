...
const FabiusBileCard = () => {
  ...
  const userId = '123';
  const itemId = 'chaos-land-raider';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require('@/assets/images/chaos-land-raider.jpg')} // Local image file
          style={styles.image}
        />
      </View>
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.titleRow}>
          <Text style={styles.name}>Chaos Land Raider</Text>
        ...
        <Text style={styles.sectionName}>Soulshatter lascannon</Text>
        <View style={styles.weaponTable}>
          {renderWeaponRow(['Range', 'A', 'BS', 'S', 'AP', 'D'], true)}
